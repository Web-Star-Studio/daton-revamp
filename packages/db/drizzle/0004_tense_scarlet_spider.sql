...
ALTER TABLE "departments" ADD CONSTRAINT "departments_manager_employee_id_employees_id_fk" FOREIGN KEY ("manager_employee_id") REFERENCES "public"."employees"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "positions_organization_idx" ON "positions" USING btree ("organization_id");--> statement-breakpoint
...
CREATE INDEX "employees_org_name_idx" ON "employees" USING btree ("organization_id","full_name");--> statement-breakpoint
CREATE INDEX "departments_parent_department_idx" ON "departments" USING btree ("parent_department_id");--> statement-breakpoint
CREATE INDEX "departments_manager_employee_idx" ON "departments" USING btree ("manager_employee_id");--> statement-breakpoint
CREATE INDEX "departments_org_cost_center_idx" ON "departments" USING btree ("organization_id","cost_center");--> statement-breakpoint
